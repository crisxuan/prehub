...
GITHUB_DAILY_CATEGORY ?= all
GITHUB_DAILY_NETWORK_WAIT ?= 30m
GITHUB_DAILY_NETWORK_CHECK_INTERVAL ?= 60s
...
daily-github-article:
	cd backend && GITHUB_DAILY_OUTPUT_DIR="$(GITHUB_DAILY_OUTPUT_DIR)" GITHUB_DAILY_IMAGE_BED_DIR="$(GITHUB_DAILY_IMAGE_BED_DIR)" GITHUB_DAILY_IMAGE_BED_BASE_URL="$(GITHUB_DAILY_IMAGE_BED_BASE_URL)" GITHUB_DAILY_IMAGE_BED_PATH="$(GITHUB_DAILY_IMAGE_BED_PATH)" GITHUB_DAILY_CATEGORY="$(GITHUB_DAILY_CATEGORY)" GITHUB_DAILY_NETWORK_WAIT="$(GITHUB_DAILY_NETWORK_WAIT)" GITHUB_DAILY_NETWORK_CHECK_INTERVAL="$(GITHUB_DAILY_NETWORK_CHECK_INTERVAL)" go run ./cmd/dailyarticle
